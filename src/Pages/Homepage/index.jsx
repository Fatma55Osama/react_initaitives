...
export default function HomePage() {
  const [Baby, setBaby] = useState([{ img: bebrona, title: 'Baby Milk', text: 'available, but the majority have suffered alteration in some form, by injected' }, { img: babyclothes, title: 'Baby Clothes', text: 'available, but the majority have suffered alteration in some form, by injected' },
  { img: baby, title: 'Baby', text: 'available, but the majority have suffered alteration in some form, by injected' },
  { img: babywalk, title: 'Baby Walk', text: 'available, but the majority have suffered alteration in some form, by injected' }])
  ...
  return (
    <div className={styles.parent}>
      ...
      <div className='col-12  py-3' id={styles.sectionBaby}>
        <div className='container col-9 d-flex justify-content-between '>
          {
            Baby.map((el, index) => (
              <div key={index} className=' text-white d-flex flex-column align-items-start gap-1' id={styles.cardbaby} >
          ...
          <div className=' text-white d-flex text-end' id={styles.about}>
            <div className='container  d-flex flex-column justify-content-center mx-2 '>
              ...
              <div className='d-flex align-items-center justify-content-end gap-2'>
                <hr />
                <span className=''>قراءة المزيد  </span>
              </div>
            </div>
              ...
              <div className='  col-12 d-flex flex-wrap  gap-3' >
                {
                  governorate.map((el, index) => (
                    <div key={index} className={`col-5 d-flex flex-column  bg-white d-flex justify-content-center align-items-center rounded py-2 gap-2 ${styles.govern}   `}>
      ...
      <div className='col-12'>
        <div className='container py-5 d-flex flex-column justify-content-center align-items-center gap-4' id={styles.ourTeams}>
